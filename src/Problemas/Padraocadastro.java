 ...
 */
public class Padraocadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, -1, -1));

        jButton8.setText("Kits");
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 180, 30));

        jButton9.setText("Contas Contábeis");
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, 180, 30));

        jButton10.setText("Lista de Preço");
        ...
        getContentPane().add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 180, 30));

        jButton13.setText("CEST");
        ...
        getContentPane().add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 180, 30));
   ...
   e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Padraocadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Padraocadastro().setVisible(true);
