 ...
 */
public class PadraoSinc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setText("Não Recebeu dados");
        ...
        jButton9.setText("Nao enviou dados");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, 80, -1));
   ...
   e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PadraoSinc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PadraoSinc().setVisible(true);
